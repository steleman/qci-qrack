...
public:
    ...
    virtual bitCapInt IndexedLDA(bitLenInt indexStart, bitLenInt indexLength,
                                 ...
                                 const void* values, bool resetValue = true) = 0;
    /**
    ...
    virtual bitCapInt IndexedADC(bitLenInt indexStart, bitLenInt indexLength,
                                 bitLenInt valueStart, bitLenInt valueLength,
                                 bitLenInt carryIndex, const void* values) = 0;
    /**
     ...
     */
    virtual void Hash(bitLenInt start, bitLenInt length, const void* values) = 0;
