...
protected:
    ...
    void INCDECSC(bitCapInt toMod, bitLenInt inOutStart, bitLenInt length,
                  bitLenInt overflowIndex, bitLenInt carryIndex);

#if ENABLE_BCD
    void INCDECBCDC(bitCapInt toMod, bitLenInt inOutStart, bitLenInt length,
    ...
    bitCapIntOcl OpIndexed(OCLAPI api_call, bitCapIntOcl carryIn,
