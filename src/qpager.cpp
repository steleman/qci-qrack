...
bitCapInt QPager::IndexedLDA(bitLenInt indexStart, bitLenInt indexLength,
                             bitLenInt valueStart, bitLenInt valueLength,
                             const void* values, bool ignored) {
  CombineEngines();
  return qPages[0U]->IndexedLDA(indexStart, indexLength, valueStart,
                                valueLength, values, ignored);
}

bitCapInt QPager::IndexedADC(bitLenInt indexStart, bitLenInt indexLength,
                             bitLenInt valueStart, bitLenInt valueLength,
                             bitLenInt carryIndex, const void* values) {
  CombineEngines();
  return qPages[0U]->IndexedADC(indexStart, indexLength, valueStart,
                                valueLength, carryIndex, values);
}

bitCapInt QPager::IndexedSBC(bitLenInt indexStart, bitLenInt indexLength,
                             bitLenInt valueStart, bitLenInt valueLength,
                             bitLenInt carryIndex, const void* values) {
  CombineEngines();
...
void QPager::Hash(bitLenInt start, bitLenInt length, const void* values) {
  CombineEngines();
